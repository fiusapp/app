...
PensumCivilPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
        selector: 'page-pensum-civil',template:/*ion-inline-start:"/home/melissa/Documentos/Fiusapp/app/src/pages/pensum-civil/pensum-civil.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Ingeniería Civil\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n    \n  <ion-slides pager>\n      \n    <ion-slide *ngFor="let pagina of paginas">\n        \n      <h1>{{pagina.tituloSemestre}}</h1>\n      <!---->\n      <ion-list>\n        <ion-item>\n          <ion-item-group *ngFor="let nArea of nombresArea">\n            <ion-item-divider color="light">{{nArea}}</ion-item-divider>\n            <ion-list>\n              <ion-item *ngFor="let curso of pagina.nombres">\n                {{curso.nombre}}\n              </ion-item>\n\n            </ion-list>\n            \n          </ion-item-group>\n        </ion-item>\n      </ion-list>\n    </ion-slide>\n  </ion-slides>\n</ion-content>'/*ion-inline-end:"/home/melissa/Documentos/Fiusapp/app/src/pages/pensum-civil/pensum-civil.html"*/,
    }),
